...
export default function useGetReportSaleByCustomer() {
  ...
  /** DUMY */
  const DUMMY_DATA: IGetReportSaleByCustomerResponse = {
    summary: {
      grand_total: 3250000,
    },
    data: [
    ...
    pagination: {
      current_page: 1,
      first_page_url: "https://api.example.com/reports/sale-by-customer?page=1",
      from: 1,
      last_page: 1,
      last_page_url: "https://api.example.com/reports/sale-by-customer?page=1",
      links: [
        { url: null, label: "&laquo; Previous", page: null, active: false },
        {
          url: "https://api.example.com/reports/sale-by-customer?page=1",
          label: "1",
          page: 1,
          active: true,
        },
      ...
      next_page_url: null,
      path: "https://api.example.com/reports/sale-by-customer",
      per_page: 10,
      prev_page_url: null,
      to: 3,
      total: 3,
