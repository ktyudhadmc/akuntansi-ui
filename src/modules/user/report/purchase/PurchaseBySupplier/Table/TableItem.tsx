...
import type { PurchaseBySupplier } from "@services/user/report/purchase-by-supplier/interfaces/response.type";

interface Props {
  item: PurchaseBySupplier;
}
