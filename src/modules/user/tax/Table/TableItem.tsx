...
export default function TableItem({ item }: Props) {
  return (
    <tr>
      <td className="px-5 py-1 text-black text-start text-theme-xs dark:text-white font-semibold">
        {item.name}
      </td>
      <td className="px-5 py-1 text-gray-500 text-end text-theme-xs dark:text-gray-400">
        {item.rate}
      </td>
