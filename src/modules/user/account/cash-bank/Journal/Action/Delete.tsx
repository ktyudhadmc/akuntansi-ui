...
import useDeleteTransaction from "@services/user/account/cash-bank/hooks/useDeleteTransaction";
...
export default function Delete({ id, code, onOpen, onClose }: Props) {
