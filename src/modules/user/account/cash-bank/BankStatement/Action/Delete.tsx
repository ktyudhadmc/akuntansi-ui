...
import useDeleteBankStatement from "@services/user/account/cash-bank/hooks/useDeleteBankStatement";
...
export default function BankStatementDelete({
  id,
  name,
  onOpen,
  onClose,
}: Props) {
  const { deleteData } = useDeleteBankStatement();
