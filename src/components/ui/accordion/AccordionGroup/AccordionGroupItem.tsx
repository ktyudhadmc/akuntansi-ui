  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
      ...
      <button
        ...
        className={`flex w-full items-center justify-between py-3 pl-6 pr-3 dark:bg-white/[0.03] ${isOpen ? "bg-gray-50" : "bg-white"}`}
      >
      ...
      >
        <div
          ref={contentRef}
          className="px-6 py-7 text-base text-gray-500 dark:text-gray-400"
        >
          {children}
        </div>
      </div>
