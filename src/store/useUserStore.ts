...
import createUserBalanceSheetSlice, {
  type UserBalanceSheetState,
} from "./slices/user/report/balance-sheet";

import createUserReportSaleSlice, {
...
import createUserTransactionSlice, {
  type UserTransactionState,
} from "./slices/user/transaction.slice";
...
const useUserStore = create<BoundSliceTypes>()((...setter) => ({
  ...
  ...createUserTransactionSlice(...setter),
}));
