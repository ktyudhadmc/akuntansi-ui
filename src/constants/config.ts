...
/** TEMPLATE */
export const TEMPLATE_IMPORT_PURCHASE = appEnv.TEMPLATE_IMPORT_PURCHASE;
export const TEMPLATE_IMPORT_SALE = appEnv.TEMPLATE_IMPORT_SALE;
export const TEMPLATE_IMPORT_CASH_BANK = appEnv.TEMPLATE_IMPORT_CASH_BANK;
